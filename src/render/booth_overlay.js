// Foreground telephone booth sliding door overlay (grid panels)
import { VW, GROUND_Y } from '../core/constants.js';
import { telephoneBooth, cameraX } from '../core/state.js';

export function drawBoothDoorOverlay(ctx) {
  ...
  // Sliding left/right panels that reveal the boss
